...
$$\notagc_v = \sum_{s\neq v \neq t}\frac{\text{number of shortest paht between s and t that contains v}}{\# \text{ of shortest paths between s and t}}$$
...
$$\notage_v = \frac{\text{number of edges among neighboring nodes}}{k_v\choose2} \in [0, 1]$$
